...
try:
    ...
    os.environ['DISABLE_MUJOCO_RENDERING'] = ''
    import importlib
    importlib.reload(humanoid_CMU.mujoco.engine.render)
except ImportError as e:
...
def main(args):
    ...
    def traj_segment_generator_cmu(pi, env, stochastic):
    ...
    if args.env_id == 'humanoid_CMU_run':
        seg_gen = traj_segment_generator_cmu(pi, env, stochastic=True)
    else:

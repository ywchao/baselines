...
time python -m baselines.ppo2.run_roboschool \
  --env=RoboschoolHumanoidBullet3-rSit-train-v1 \
  --seed=$seed \
...
OUT_DIR="output/ppo2/RoboschoolHumanoidBullet3-rSit-train-v1.seed_$seed.num-timesteps_2.50e+07"

time python -m baselines.ppo2.vis_model \
  --env=RoboschoolHumanoidBullet3-rSit-v1 \
  --seed=0 \

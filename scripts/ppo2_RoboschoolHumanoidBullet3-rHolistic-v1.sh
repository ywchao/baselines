...
time python -m baselines.ppo2.run_roboschool \
  --env=RoboschoolHumanoidBullet3-rHolistic-train-v1 \
  --seed=$seed \
...
OUT_DIR="output/ppo2/RoboschoolHumanoidBullet3-rHolistic-train-v1.seed_$seed.num-timesteps_8.00e+07"

time python -m baselines.ppo2.vis_model \
  --env=RoboschoolHumanoidBullet3-rHolistic-v1 \
  --seed=0 \

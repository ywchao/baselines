...
time python -m baselines.ppo2.run_roboschool \
  --env=RoboschoolHumanoidBullet3-rTurnLeft-train-v1 \
  --seed=$seed \
...
OUT_DIR="output/ppo2/RoboschoolHumanoidBullet3-rTurnLeft-train-v1-ft.seed_$seed.num-timesteps_3.00e+07"

time python -m baselines.ppo2.vis_model \
  --env=RoboschoolHumanoidBullet3-rTurnLeft-v1 \
  --seed=0 \
